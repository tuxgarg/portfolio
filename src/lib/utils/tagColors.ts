const techColors: Record<string, string> = {
    ...
    'React Native': 'bg-cyan-200 text-cyan-800',
    ...
    'Kotlin': 'bg-indigo-200 text-indigo-800',
    ...
    'npm': 'bg-red-200 text-red-800',
    'Electronjs': 'bg-blue-200 text-blue-800'
  };
